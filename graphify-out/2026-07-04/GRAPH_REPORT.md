...
Cohesion: 0.16
Nodes (4): MyStackPage(), num(), pct(), QUICK_RISK
...
## Knowledge Gaps
- **2854 isolated node(s):** `EMPTY_DIV_MARKERS`, `TradeOverlayProps`, `ChartContextMenuProps`, `CloseConfirmDialogProps`, `OrderModalProps` (+2849 more)
...
- **What connects `EMPTY_DIV_MARKERS`, `TradeOverlayProps`, `ChartContextMenuProps` to the rest of the system?**
